...
module.exports.prototype = GamesController.prototype.extend({
  ...
  indexAction: function() {
    ...
    // TODO this.mongodb.collection('players').find( hasPlayedDaily: true).count()
    var currentGamesPlayed = 120,
    // TODO this.mongodb.collection('players').count()
    maxGamesPlayed = 200, 
    percentGamesPlayed = (currentGamesPlayed*100 / maxGamesPlayed );

    _this.view.render( {
      title: 'Daily Challenge',
      gamesPlayed: percentGamesPlayed,
  ...
  generateDailyGame: function() {
    ...
    // TODO: render game at 0:00, save in mongodb
